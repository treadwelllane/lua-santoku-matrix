...
static inline tk_ivec_t *tk_ivec_bits_bipartite(lua_State *L, tk_ivec_t *src, uint64_t n_docs, uint64_t n_labels, tk_ivec_t *rank1, uint64_t n_rank1, bool inherit, uint64_t *out_n_edges);
static inline tk_ivec_t *tk_ivec_bits_bipartite_serial(lua_State *L, tk_ivec_t *src, uint64_t n_docs, uint64_t n_labels, tk_ivec_t *rank1, uint64_t n_rank1, bool inherit, uint64_t *out_n_edges);
...
static inline uint64_t tk_ivec_bits_to_cvec_grouped (
  lua_State *L,
  tk_ivec_t *set_bits,
  uint64_t n_samples,
  uint64_t n_visible,
